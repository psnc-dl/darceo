...
/**
 * Transactional XA resource of semantic repository.
 * 
 */
public abstract class SemanticRepositoryXAResourceImpl implements XAResource {

    /** Logger. */
    private static final Logger logger = LoggerFactory.getLogger(SemanticRepositoryXAResourceImpl.class);
     ...
     */
    protected SemanticRepositoryManagedConnectionResourceManager resourceManager;
