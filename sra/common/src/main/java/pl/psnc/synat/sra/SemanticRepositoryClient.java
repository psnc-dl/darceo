...
/**
 * Interface of client to semantic repository services.
 * 
 */
public interface SemanticRepositoryClient {

    /**
     * Connects to a semantic repository.
     * 
    ...
    /**
     * Disconnects from a semantic repository.
     */
    void disconnect();


    /**
     * Commits all updates operations performed on a semantic repository connection.
     * 
    ...
    /**
     * Rollbacks all updates operations performed on a semantic repository connection.
     * 
    ...
    /**
     * Execute a SPARQL select query and returns a list of tuples.
     * 
     * @param query
     *            SPARQL select query
    ...
    /**
     * Execute a SPARQL ask query and returns a boolean result.
     * 
     * @param query
     *            SPARQL ask query
     ...
     *             if some unexpected error occurs
     */
    boolean executeSparqlAskQuery(String query)
            throws MalformedQueryException, SemanticRepositoryConnectionException;
     ...
     *             if some unexpected error occurs
     */
    void executeSparqlUpdateData(String update)
            throws MalformedQueryException, SemanticRepositoryConnectionException;
