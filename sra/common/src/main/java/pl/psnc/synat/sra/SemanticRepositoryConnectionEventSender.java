 ...
 * 
 */
public class SemanticRepositoryConnectionEventSender {

    /** Logger. */
    private static final Logger logger = LoggerFactory.getLogger(SemanticRepositoryConnectionEventSender.class);
     ...
     * Managed connection.
     */
    private SemanticRepositoryManagedConnectionImpl managedConnection;
     ...
     *            managed connection
     */
    public SemanticRepositoryConnectionEventSender(SemanticRepositoryManagedConnectionImpl managedConnection) {
     ...
     */
    public void sendEvent(int eventType, Exception ex, SemanticRepositoryConnectionImpl connection) {
