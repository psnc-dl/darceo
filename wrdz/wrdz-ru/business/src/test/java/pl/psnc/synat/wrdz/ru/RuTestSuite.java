...
/**
 * Test suite for the RU module.
 */
@RunWith(Suite.class)
@SuiteClasses({})
public class RuTestSuite extends BaseTestSuite {
    ...
    public static void setUpBeforeRuBaseTestClass()
            throws Exception {
        setUpBeforeBaseTest(Module.COMMON, Module.ZU, Module.RU);
    }
    ...
    public static void tearDownAfterRuBaseTestClass()
            throws Exception {
        tearDownAfterBaseTestClass(Module.RU, Module.ZU, Module.COMMON);
    }
