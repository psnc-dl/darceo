...
/**
 * Bean responsible for grounding of services.
 */
@Stateless
...
public class ServiceGrounderBean implements ServiceGrounder {
    ...
    @Override
    public WadlNodes retrieveWadlNodes(String serviceIri) {
        try {
            return semanticRepositoryAccessBean.getWadlNodesForService(serviceIri);
