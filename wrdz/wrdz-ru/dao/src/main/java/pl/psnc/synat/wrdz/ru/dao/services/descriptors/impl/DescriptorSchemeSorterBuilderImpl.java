...
import pl.psnc.synat.wrdz.ru.entity.services.descriptors.DescriptorScheme_;

/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link DescriptorScheme}.
 */
public class DescriptorSchemeSorterBuilderImpl extends GenericQuerySorterBuilderImpl<DescriptorScheme> implements
        DescriptorSchemeSorterBuilder {
     ...
     */
    public DescriptorSchemeSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(DescriptorScheme_.id);
    }
