...
import pl.psnc.synat.wrdz.ru.entity.services.descriptors.TechnicalDescriptor_;

/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link TechnicalDescriptor}.
 */
public class TechnicalDescriptorSorterBuilderImpl extends GenericQuerySorterBuilderImpl<TechnicalDescriptor> implements
        TechnicalDescriptorSorterBuilder {
     ...
     */
    public TechnicalDescriptorSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(TechnicalDescriptor_.id);
    }
