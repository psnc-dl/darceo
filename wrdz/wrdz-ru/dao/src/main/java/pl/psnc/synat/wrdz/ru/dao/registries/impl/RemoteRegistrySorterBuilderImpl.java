...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link RemoteRegistry}.
 */
public class RemoteRegistrySorterBuilderImpl extends GenericQuerySorterBuilderImpl<RemoteRegistry> implements
        RemoteRegistrySorterBuilder {
     ...
     */
    public RemoteRegistrySorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(RemoteRegistry_.id);
    }


    @Override
    public RemoteRegistrySorterBuilder byLocationUrl(boolean ascendingly) {
        addOrdering(root.get(RemoteRegistry_.locationUrl), ascendingly);
        return this;
    }
