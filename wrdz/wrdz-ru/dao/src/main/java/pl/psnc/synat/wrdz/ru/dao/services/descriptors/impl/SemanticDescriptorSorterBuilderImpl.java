...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link SemanticDescriptor}.
 */
public class SemanticDescriptorSorterBuilderImpl extends GenericQuerySorterBuilderImpl<SemanticDescriptor> implements
        SemanticDescriptorSorterBuilder {
     ...
     */
    public SemanticDescriptorSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(SemanticDescriptor_.id);
    }


    @Override
    public SemanticDescriptorSorterBuilder byLocationUrl(boolean ascendingly) {
        addOrdering(root.get(SemanticDescriptor_.locationUrl), ascendingly);
        return this;
    }
