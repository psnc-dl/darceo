 ...
 */
public class DataManipulationServiceSorterBuilderImpl extends GenericQuerySorterBuilderImpl<DataManipulationService>
        implements DataManipulationServiceSorterBuilder {
     ...
     */
    public DataManipulationServiceSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(DataManipulationService_.id);
    }


    @Override
    public DataManipulationServiceSorterBuilder byLocationUrl(boolean ascendingly) {
        addOrdering(root.get(DataManipulationService_.locationUrl), ascendingly);
        return this;
    }
