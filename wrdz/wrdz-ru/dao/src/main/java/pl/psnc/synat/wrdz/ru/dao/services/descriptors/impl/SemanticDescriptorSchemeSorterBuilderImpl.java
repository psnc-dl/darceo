 ...
 */
public class SemanticDescriptorSchemeSorterBuilderImpl extends GenericQuerySorterBuilderImpl<SemanticDescriptorScheme>
        implements SemanticDescriptorSchemeSorterBuilder {
     ...
     */
    public SemanticDescriptorSchemeSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(SemanticDescriptorScheme_.id);
    }
