 ...
 */
public class TechnicalDescriptorSchemeSorterBuilderImpl extends
        GenericQuerySorterBuilderImpl<TechnicalDescriptorScheme> implements TechnicalDescriptorSchemeSorterBuilder {
     ...
     */
    public TechnicalDescriptorSchemeSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(TechnicalDescriptorScheme_.id);
    }
