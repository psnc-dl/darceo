 ...
 */
public class EntryDeletionException extends WrdzRuntimeException {
     ...
     */
    public EntryDeletionException(String message) {
        super(message);
    }
     ...
     */
    public EntryDeletionException(Exception cause) {
        super(cause);
    }
     ...
     *            the {@link Exception} that caused this exception.
     */
    public EntryDeletionException(String message, Exception cause) {
        super(message, cause);
    }
