...
public class EntryModificationException extends WrdzRuntimeException {
     ...
     */
    public EntryModificationException(String message) {
        super(message);
    }
     ...
     */
    public EntryModificationException(Exception cause) {
        super(cause);
    }
     ...
     *            the {@link Exception} that caused this exception.
     */
    public EntryModificationException(String message, Exception cause) {
        super(message, cause);
    }
