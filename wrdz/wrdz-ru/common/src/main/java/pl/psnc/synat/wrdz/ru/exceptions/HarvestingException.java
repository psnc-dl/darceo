 ...
 * 
 */
public class HarvestingException extends WrdzRuntimeException {
     ...
     */
    public HarvestingException(Exception cause) {
        super(cause);
    }
     ...
     *            the {@link Exception} that caused this exception.
     */
    public HarvestingException(String message, Exception cause) {
        super(message, cause);
    }
