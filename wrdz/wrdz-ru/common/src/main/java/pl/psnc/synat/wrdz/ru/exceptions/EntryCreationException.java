 ...
 * 
 */
public class EntryCreationException extends WrdzRuntimeException {
     ...
     */
    public EntryCreationException(Exception cause) {
        super(cause);
    }
     ...
     *            the {@link Exception} that caused this exception.
     */
    public EntryCreationException(String message, Exception cause) {
        super(message, cause);
    }
