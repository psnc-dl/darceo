...
/**
 * An interface for a class managing the persistence of {@link InternalMessage} class. It declares additional operations
 * available for {@link InternalMessage} object apart from basic contract defined in {@link GenericDao}.
 */
@Local
