...
/**
 * An interface for a class managing the persistence of {@link NotifyEmail} class. It declares additional operations
 * available for {@link NotifyEmail} object apart from basic contract defined in {@link GenericDao}.
 */
@Local
