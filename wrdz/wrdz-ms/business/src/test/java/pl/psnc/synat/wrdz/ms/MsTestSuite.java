...
/**
 * Test suite for the MS module.
 */
@RunWith(Suite.class)
@SuiteClasses({})
public class MsTestSuite extends BaseTestSuite {
    ...
    public static void setUpBeforeRuBaseTestClass()
            throws Exception {
        setUpBeforeBaseTest(Module.COMMON, Module.ZU, Module.ZMD, Module.MDZ, Module.RU, Module.MS);
    }
    ...
    public static void tearDownAfterRuBaseTestClass()
            throws Exception {
        tearDownAfterBaseTestClass(Module.MS, Module.RU, Module.MDZ, Module.ZMD, Module.ZU, Module.COMMON);
    }
