...
/**
 * Base class for all tests in the MS module.
 */
@Ignore
public class MsBaseTest extends BaseTest {

    /** Logger. */
    private static final Logger logger = LoggerFactory.getLogger(MsBaseTest.class);
    ...
    public void setUpRuBaseTest()
            throws Exception {
        logger.debug(this.getClass() + " MS test set up");
        setUpBaseTest();
    }
    ...
    public void tearDownRuBaseTest()
            throws Exception {
        logger.debug(this.getClass() + " MS test tear down");
        tearDownBaseTest();
    }
