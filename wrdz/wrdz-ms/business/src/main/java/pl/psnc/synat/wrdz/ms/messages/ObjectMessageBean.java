...
/**
 * Message-driven bean that reads object integrity notifications from MDZ and persists them in the MS database.
 */
@MessageDriven(activationConfig = {
        @ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
        @ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge") })
public class ObjectMessageBean implements MessageListener {

    /** Logger. */
    private static final Logger logger = LoggerFactory.getLogger(ObjectMessageBean.class);
    ...
    public void onMessage(Message message) {
        try {
            ...
            internalMessage.setType(InternalMessageType.CORRUPTED_OBJECT);
