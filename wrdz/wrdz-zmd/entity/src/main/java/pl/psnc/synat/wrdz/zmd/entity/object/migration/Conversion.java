...
/**
 * An entity representing operation of conversion, i.e. lossy transmutation of any type of digital object or part of it
 * into new object of type {@link ConvertedObject} that can be used for presentation purposes.
 */
@Entity
@DiscriminatorValue("CONVERSION")
public class Conversion extends Migration<DigitalObject, ConvertedObject> {

    /**
     * Serial version UID.
     */
    private static final long serialVersionUID = -274567726224242007L;
    ...
    private ConvertedObject result;


    /**
     * Creates new instance of conversion operation.
     */
    public Conversion() {
        super(MigrationType.CONVERSION);
    }


    public DigitalObject getSource() {
        return source;
    }


    public void setSource(DigitalObject source) {
        this.source = source;
    }


    public ConvertedObject getResult() {
        return result;
    }


    public void setResult(ConvertedObject result) {
        this.result = result;
    }
