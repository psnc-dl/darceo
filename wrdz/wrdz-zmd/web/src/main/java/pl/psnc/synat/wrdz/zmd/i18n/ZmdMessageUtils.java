 ...
 */
package pl.psnc.synat.wrdz.zmd.i18n;
 ...
 */
public final class ZmdMessageUtils {

    /** No instances. */
    private ZmdMessageUtils() {
    ...
    public static String getMessage(String key) {
        String text = null;
        try {
            ResourceBundle bundle = ResourceBundle.getBundle("pl.psnc.synat.wrdz.zmd.i18n.ZmdResourceBundle",
