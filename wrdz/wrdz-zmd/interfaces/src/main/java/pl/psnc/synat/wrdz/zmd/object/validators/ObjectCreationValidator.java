...
/**
 * Interface for object creation request validator.
 */
@Local
public interface ObjectCreationValidator {
     ...
     */
    void validateObjectCreationRequest(ObjectCreationRequest creationRequest)
            throws ObjectCreationException;
