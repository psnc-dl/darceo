...
/**
 * Thrown when deletion of a digital object or its version failed.
 */
...
public class ObjectDeletionException extends WrdzException {
    ...
    /**
     * Constructs a new <code>ObjectDeletionException</code> with the specified detail message.
     * 
     * @param message
     *            the detail message
     */
    ...
    /**
     * Constructs a new <code>ObjectDeletionException</code> with the specified detail message and cause.
     * 
     * @param message
     *            the detail message
     * @param cause
