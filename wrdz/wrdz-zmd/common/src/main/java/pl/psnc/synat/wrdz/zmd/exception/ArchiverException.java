...
/**
 * Thrown when the archiving operation encountered error.
 */
public class ArchiverException extends WrdzException {

    /**
     * Serial version UID.
     */
    private static final long serialVersionUID = 488716547558051006L;
