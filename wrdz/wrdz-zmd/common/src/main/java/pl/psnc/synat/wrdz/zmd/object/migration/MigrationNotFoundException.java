...
/**
 * Thrown when an operation concerns a migration that does not exist.
 */
public class MigrationNotFoundException extends WrdzException {
    ...
    /**
     * Constructs a new <code>MigrationNotFoundException</code> with the specified detail message.
     * 
     * @param message
     *            the detail message
     */
