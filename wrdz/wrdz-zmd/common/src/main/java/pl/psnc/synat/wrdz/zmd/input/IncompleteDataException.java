...
/**
 * Thrown when the request for operation on some digital object is incomplete.
 */
public class IncompleteDataException extends WrdzException {
    ...
    /**
     * Constructs a new <code>IncompleteDataException</code> with the specified detail message.
     * 
     * @param message
     *            the detail message
     */
