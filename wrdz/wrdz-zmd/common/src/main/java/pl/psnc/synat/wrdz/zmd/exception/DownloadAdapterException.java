...
public class DownloadAdapterException extends WrdzException {
     ...
     *            the detail message
     */
    public DownloadAdapterException(String message) {
        super(message);
    }
     ...
     *            the cause
     */
    public DownloadAdapterException(Throwable cause) {
        super(cause);
    }
     ...
     *            the cause
     */
    public DownloadAdapterException(String message, Throwable cause) {
        super(message, cause);
    }
