...
/**
 * Default implementation of {@link DataFileVersionSorterBuilder}.
 */
public class DataFileVersionSorterBuilderImpl extends GenericQuerySorterBuilderImpl<DataFileVersion> implements
        DataFileVersionSorterBuilder {
     ...
     */
    public DataFileVersionSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(DataFileVersion_.id);
    }
