 ...
 */
public class FileExtractedMetadataSorterBuilderImpl extends GenericQuerySorterBuilderImpl<FileExtractedMetadata>
        implements FileExtractedMetadataSorterBuilder {
     ...
     */
    public FileExtractedMetadataSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(FileExtractedMetadata_.id);
    }
