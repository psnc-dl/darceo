...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link MasterObject}.
 */
public class MasterObjectSorterBuilderImpl extends GenericQuerySorterBuilderImpl<MasterObject> implements
        MasterObjectSorterBuilder {
     ...
     */
    public MasterObjectSorterBuilderImpl(CriteriaBuilder criteriaBuilder, CriteriaQuery<MasterObject> criteriaQuery,
    ...
    protected Path<?> getIdPath() {
        return root.get(MasterObject_.id);
    }
