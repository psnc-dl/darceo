...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link FileProvidedMetadata}
 * .
 */
public class FileProvidedMetadataSorterBuilderImpl extends GenericQuerySorterBuilderImpl<FileProvidedMetadata>
        implements FileProvidedMetadataSorterBuilder {
     ...
     */
    public FileProvidedMetadataSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(FileProvidedMetadata_.id);
    }
