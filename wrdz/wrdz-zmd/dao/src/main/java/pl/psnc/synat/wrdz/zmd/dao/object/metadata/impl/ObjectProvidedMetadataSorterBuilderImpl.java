 ...
 */
public class ObjectProvidedMetadataSorterBuilderImpl extends GenericQuerySorterBuilderImpl<ObjectProvidedMetadata>
        implements ObjectProvidedMetadataSorterBuilder {
     ...
     */
    public ObjectProvidedMetadataSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(ObjectProvidedMetadata_.id);
    }
