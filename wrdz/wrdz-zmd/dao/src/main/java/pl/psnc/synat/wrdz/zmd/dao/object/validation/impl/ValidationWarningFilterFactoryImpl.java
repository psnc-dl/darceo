...
/**
 * Class providing easy access to creation of filtering arguments for the queries concerning {@link ValidationWarning}.
 */
public class ValidationWarningFilterFactoryImpl extends GenericQueryFilterFactoryImpl<ValidationWarning> implements
        ValidationWarningFilterFactory {
     ...
     * 
     */
    public ValidationWarningFilterFactoryImpl(CriteriaBuilder criteriaBuilder,
    ...
    @Override
    public QueryFilter<ValidationWarning> byWarning(String warning) {
        Predicate predicate = criteriaBuilder.equal(root.get(ValidationWarning_.warning), warning);
