...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link Optimization}.
 */
public class OptimizationSorterBuilderImpl extends GenericQuerySorterBuilderImpl<Optimization> implements
        OptimizationSorterBuilder {
     ...
     */
    public OptimizationSorterBuilderImpl(CriteriaBuilder criteriaBuilder, CriteriaQuery<Optimization> criteriaQuery,
    ...
    protected Path<?> getIdPath() {
        return root.get(Optimization_.id);
    }
