...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link Identifier}.
 */
public class IdentifierSorterBuilderImpl extends GenericQuerySorterBuilderImpl<Identifier> implements
        IdentifierSorterBuilder {
     ...
     */
    public IdentifierSorterBuilderImpl(CriteriaBuilder criteriaBuilder, CriteriaQuery<Identifier> criteriaQuery,
    ...
    protected Path<?> getIdPath() {
        return root.get(Identifier_.id);
    }
