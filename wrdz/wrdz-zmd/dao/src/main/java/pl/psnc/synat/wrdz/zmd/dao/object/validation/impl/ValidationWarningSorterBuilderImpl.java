...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link ValidationWarning}.
 */
public class ValidationWarningSorterBuilderImpl extends GenericQuerySorterBuilderImpl<ValidationWarning> implements
        ValidationWarningSorterBuilder {
     ...
     */
    public ValidationWarningSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(ValidationWarning_.id);
    }
