...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link Operation}.
 */
public class OperationSorterBuilderImpl extends GenericQuerySorterBuilderImpl<Operation> implements
        OperationSorterBuilder {
     ...
     */
    public OperationSorterBuilderImpl(CriteriaBuilder criteriaBuilder, CriteriaQuery<Operation> criteriaQuery,
    ...
    protected Path<?> getIdPath() {
        return root.get(Operation_.id);
    }


    @Override
    public OperationSorterBuilder byDate(boolean ascendingly) {
        addOrdering(root.get(Operation_.date), ascendingly);
        return this;
    }
