...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link DataFileFormat}.
 */
public class DataFileFormatSorterBuilderImpl extends GenericQuerySorterBuilderImpl<DataFileFormat> implements
        DataFileFormatSorterBuilder {
     ...
     */
    public DataFileFormatSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(DataFileFormat_.id);
    }
