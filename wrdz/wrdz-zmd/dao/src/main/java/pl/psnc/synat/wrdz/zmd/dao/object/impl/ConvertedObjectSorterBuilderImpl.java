...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link ConvertedObject}.
 */
public class ConvertedObjectSorterBuilderImpl extends GenericQuerySorterBuilderImpl<ConvertedObject> implements
        ConvertedObjectSorterBuilder {
     ...
     */
    public ConvertedObjectSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(ConvertedObject_.id);
    }
