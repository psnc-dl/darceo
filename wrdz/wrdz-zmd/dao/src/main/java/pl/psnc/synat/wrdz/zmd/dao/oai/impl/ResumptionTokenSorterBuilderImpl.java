...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link ResumptionToken}.
 */
public class ResumptionTokenSorterBuilderImpl extends GenericQuerySorterBuilderImpl<ResumptionToken> implements
        ResumptionTokenSorterBuilder {
     ...
     */
    public ResumptionTokenSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(ResumptionToken_.id);
    }
