 ...
 * {@link ObjectExtractedMetadata}.
 */
public class ObjectExtractedMetadataSorterBuilderImpl extends GenericQuerySorterBuilderImpl<ObjectExtractedMetadata>
        implements ObjectExtractedMetadataSorterBuilder {
     ...
     */
    public ObjectExtractedMetadataSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(ObjectExtractedMetadata_.id);
    }
