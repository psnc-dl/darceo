...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link Transformation}.
 */
public class TransformationSorterBuilderImpl extends GenericQuerySorterBuilderImpl<Transformation> implements
        TransformationSorterBuilder {
     ...
     */
    public TransformationSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(Transformation_.id);
    }
