...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link OptimizedObject}.
 */
public class OptimizedObjectSorterBuilderImpl extends GenericQuerySorterBuilderImpl<OptimizedObject> implements
        OptimizedObjectSorterBuilder {
     ...
     */
    public OptimizedObjectSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(OptimizedObject_.id);
    }
