...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link Conversion}.
 */
public class ConversionSorterBuilderImpl extends GenericQuerySorterBuilderImpl<Conversion> implements
        ConversionSorterBuilder {
     ...
     */
    public ConversionSorterBuilderImpl(CriteriaBuilder criteriaBuilder, CriteriaQuery<Conversion> criteriaQuery,
            Root<Conversion> root, Long epoch)
            throws IllegalArgumentException {
    ...
    protected Path<?> getIdPath() {
        return root.get(Conversion_.id);
    }
