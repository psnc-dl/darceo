...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link DataFileFormatName}.
 */
public class DataFileFormatNameSorterBuilderImpl extends GenericQuerySorterBuilderImpl<DataFileFormatName> implements
        DataFileFormatNameSorterBuilder {
     ...
     */
    public DataFileFormatNameSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(DataFileFormatName_.id);
    }
