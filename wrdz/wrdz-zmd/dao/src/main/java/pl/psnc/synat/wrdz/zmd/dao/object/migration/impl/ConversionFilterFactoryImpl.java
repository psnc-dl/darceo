...
/**
 * Class providing easy access to creation of filtering arguments for the queries concerning {@link Conversion}.
 */
public class ConversionFilterFactoryImpl extends GenericQueryFilterFactoryImpl<Conversion> implements
        ConversionFilterFactory {
     ...
     * 
     */
    public ConversionFilterFactoryImpl(CriteriaBuilder criteriaBuilder, CriteriaQuery<Conversion> criteriaQuery,
