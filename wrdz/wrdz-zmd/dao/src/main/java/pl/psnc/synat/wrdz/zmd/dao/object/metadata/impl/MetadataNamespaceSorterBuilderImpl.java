...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link MetadataNamespace}.
 */
public class MetadataNamespaceSorterBuilderImpl extends GenericQuerySorterBuilderImpl<MetadataNamespace> implements
        MetadataNamespaceSorterBuilder {
     ...
     */
    public MetadataNamespaceSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(MetadataNamespace_.id);
    }
