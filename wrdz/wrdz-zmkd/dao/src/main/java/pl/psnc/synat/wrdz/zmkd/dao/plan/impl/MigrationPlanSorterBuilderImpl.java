...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link MigrationPlan}.
 * 
 */
public class MigrationPlanSorterBuilderImpl extends GenericQuerySorterBuilderImpl<MigrationPlan> implements
        MigrationPlanSorterBuilder {
     ...
     */
    public MigrationPlanSorterBuilderImpl(CriteriaBuilder criteriaBuilder, CriteriaQuery<MigrationPlan> criteriaQuery,
    ...
    protected Path<?> getIdPath() {
        return root.get(MigrationPlan_.id);
    }
