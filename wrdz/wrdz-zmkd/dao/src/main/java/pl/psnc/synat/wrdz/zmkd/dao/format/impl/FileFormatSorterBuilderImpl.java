 ...
 * {@link FileFormat}.
 */
public class FileFormatSorterBuilderImpl extends GenericQuerySorterBuilderImpl<FileFormat>
        implements FileFormatSorterBuilder {
     ...
     */
    public FileFormatSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(FileFormat_.puid);
    }
