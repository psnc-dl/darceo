...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link MigrationItemLog}.
 * 
 */
public class MigrationItemLogSorterBuilderImpl extends GenericQuerySorterBuilderImpl<MigrationItemLog> implements
        MigrationItemLogSorterBuilder {
     ...
     */
    public MigrationItemLogSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(MigrationItemLog_.id);
    }
