 ...
 */
package pl.psnc.synat.wrdz.zmkd.session;
...
public class LoginBean {
    ...
    public String login() {
        ...
        try {
            ...
            FacesMessage message = new FacesMessage(ZmkdMessageUtils.getMessage("login.unknown_username_or_password"));
            message.setSeverity(FacesMessage.SEVERITY_ERROR);
            context.addMessage("login-form:username", message);
            return "";
        }
        return "plans/plans.xhtml?faces-redirect=true";
    }
