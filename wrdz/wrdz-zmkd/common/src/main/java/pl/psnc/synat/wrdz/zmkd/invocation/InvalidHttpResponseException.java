...
/**
 * Thrown when retrieved HTTP response is invalid or the invocation failed.
 */
public class InvalidHttpResponseException extends WrdzException {

    /** Serial Version UID. */
    private static final long serialVersionUID = 1236005638319249980L;
