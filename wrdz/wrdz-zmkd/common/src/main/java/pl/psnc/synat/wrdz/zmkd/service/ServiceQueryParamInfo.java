...
/**
 * Detailed information about a particular query parameter of the transformation.
 */
public class ServiceQueryParamInfo {
    ...
    /** Values --- list of string representations of values of the technicalType type. */
