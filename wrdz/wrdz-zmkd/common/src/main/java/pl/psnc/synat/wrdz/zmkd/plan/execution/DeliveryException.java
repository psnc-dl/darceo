...
/**
 * Thrown when delivery failed for some reason.
 */
public class DeliveryException extends WrdzException {
     ...
     *            the detail message
     */
    public DeliveryException(String serviceIri, String message) {
        super(message);
     ...
     *            the cause
     */
    public DeliveryException(String serviceIri, Throwable cause) {
        super(cause);
        this.serviceIri = serviceIri;
    }
     ...
     *            the cause
     */
    public DeliveryException(String serviceIri, String message, Throwable cause) {
        super(message, cause);
        this.serviceIri = serviceIri;
    }
