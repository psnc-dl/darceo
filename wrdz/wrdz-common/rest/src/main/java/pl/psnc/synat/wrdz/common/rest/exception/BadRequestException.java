...
/**
 * WebApplicationException returning 400 HTTP code (Bad Request) when it is raised.
 */
public class BadRequestException extends WebApplicationException {
    ...
    /**
     * Constructs a new <code>BadRequestException</code> without any message.
     */
    ...
    /**
     * Constructs a new <code>BadRequestException</code> with the specified detail message.
     * 
     * @param message
     *            the detail message
     */
