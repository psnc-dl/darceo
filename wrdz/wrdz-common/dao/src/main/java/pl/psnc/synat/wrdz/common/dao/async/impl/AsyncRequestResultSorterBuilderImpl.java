...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link AsyncRequestResult}.
 */
public class AsyncRequestResultSorterBuilderImpl extends GenericQuerySorterBuilderImpl<AsyncRequestResult> implements
        AsyncRequestResultSorterBuilder {
     ...
     */
    public AsyncRequestResultSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(AsyncRequestResult_.id);
    }
