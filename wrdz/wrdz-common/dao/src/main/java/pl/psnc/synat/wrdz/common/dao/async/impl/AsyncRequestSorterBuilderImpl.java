...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link AsyncRequest}.
 */
public class AsyncRequestSorterBuilderImpl extends GenericQuerySorterBuilderImpl<AsyncRequest> implements
        AsyncRequestSorterBuilder {
     ...
     */
    public AsyncRequestSorterBuilderImpl(CriteriaBuilder criteriaBuilder, CriteriaQuery<AsyncRequest> criteriaQuery,
    ...
    protected Path<?> getIdPath() {
        return root.get(AsyncRequest_.id);
    }
