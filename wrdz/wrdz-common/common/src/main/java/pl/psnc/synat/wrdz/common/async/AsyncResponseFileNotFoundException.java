...
/**
 * Thrown when a file with the response for asynchronous request does not exist.
 */
public class AsyncResponseFileNotFoundException extends WrdzException {
    ...
    /**
     * Constructs a new <code>AsyncResponseFileNotFoundException</code> with the specified detail message.
     * 
     * @param message
     *            the detail message
     */
    public AsyncResponseFileNotFoundException(String message) {
        super(message);
    }
