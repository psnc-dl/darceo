...
public class PremisMetadata extends AdmMetadata {
    ...
    /**
     * Constructs administrative metadata object in the Premis schema.
     * 
     * @param metadata
     *            administrative metadata
     */
    public PremisMetadata(String metadata) {
        super(metadata, new AdmMetadataType(AdmMetadataType.Type.PREMIS));
    }
