...
/**
 * Base class for all tests in the ZU module.
 */
@Ignore
public class ZuBaseTest extends BaseTest {

    /** Logger. */
    private static final Logger logger = LoggerFactory.getLogger(ZuBaseTest.class);
    ...
    public void setUpRuBaseTest()
            throws Exception {
        logger.debug(this.getClass() + " ZU test set up");
        setUpBaseTest();
    }
    ...
    public void tearDownRuBaseTest()
            throws Exception {
        logger.debug(this.getClass() + " ZU test tear down");
        tearDownBaseTest();
    }
