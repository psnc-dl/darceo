...
/**
 * Represents permissions on a specific service granted to specific usergroup.
 */
@Entity
@DiscriminatorValue("USER")
public class GroupManagementPermission extends ResourcePermission {

    /**
     * Serial version UID.
     */
    private static final long serialVersionUID = 8221559341238164694L;
    ...
    private ManagementPermissionType permission;


    public ManagementPermissionType getPermission() {
        return permission;
    }


    public void setPermission(ManagementPermissionType permission) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof GroupManagementPermission)) {
            return false;
        }
        GroupManagementPermission other = (GroupManagementPermission) obj;
        if (group == null) {
