...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link GroupAuthentication}.
 */
public class GroupAuthenticationSorterBuilderImpl extends GenericQuerySorterBuilderImpl<GroupAuthentication> implements
        GroupAuthenticationSorterBuilder {
     ...
     */
    public GroupAuthenticationSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(GroupAuthentication_.id);
    }
