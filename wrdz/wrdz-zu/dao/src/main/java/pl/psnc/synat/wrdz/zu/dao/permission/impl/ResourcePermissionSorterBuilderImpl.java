...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link ResourcePermission}.
 */
public class ResourcePermissionSorterBuilderImpl extends GenericQuerySorterBuilderImpl<ResourcePermission> implements
        ResourcePermissionSorterBuilder {
     ...
     */
    public ResourcePermissionSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(ResourcePermission_.id);
    }
