...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link User}.
 */
public class UserSorterBuilderImpl extends GenericQuerySorterBuilderImpl<User> implements UserSorterBuilder {
     ...
     */
    public UserSorterBuilderImpl(CriteriaBuilder criteriaBuilder, CriteriaQuery<User> criteriaQuery, Root<User> root,
            Long epoch)
            throws IllegalArgumentException {
