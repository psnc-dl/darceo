...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link UserAuthentication}.
 */
public class UserAuthenticationSorterBuilderImpl extends GenericQuerySorterBuilderImpl<UserAuthentication> implements
        UserAuthenticationSorterBuilder {
     ...
     */
    public UserAuthenticationSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(UserAuthentication_.user);
    }
