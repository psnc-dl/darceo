...
/**
 * Class providing easy access to creation of ordering arguments for the queries concerning {@link ObjectPermission}.
 */
public class ObjectPermissionSorterBuilderImpl extends GenericQuerySorterBuilderImpl<ObjectPermission> implements
        ObjectPermissionSorterBuilder {
     ...
     */
    public ObjectPermissionSorterBuilderImpl(CriteriaBuilder criteriaBuilder,
    ...
    protected Path<?> getIdPath() {
        return root.get(ObjectPermission_.id);
    }
