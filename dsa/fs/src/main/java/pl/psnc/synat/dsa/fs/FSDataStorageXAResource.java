...
/**
 * Transactional XA resource of data storage based on file system.
 * 
 */
public class FSDataStorageXAResource extends DataStorageXAResource {

    /** Logger. */
    private static final Logger logger = LoggerFactory.getLogger(FSDataStorageXAResource.class);
     ...
     *            list of operations
     */
    public FSDataStorageXAResource(List<DataStorageClient> clients,
