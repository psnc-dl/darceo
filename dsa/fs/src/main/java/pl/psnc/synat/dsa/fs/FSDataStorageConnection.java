...
/**
 * Connection to data storage based on file system.
 * 
 */
public class FSDataStorageConnection extends AbstractDataStorageConnection {
     ...
     *            managed connection
     */
    public FSDataStorageConnection(DataStorageManagedConnection managedConnection) {
