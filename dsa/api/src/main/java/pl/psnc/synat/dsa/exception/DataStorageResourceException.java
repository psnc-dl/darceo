...
public class DataStorageResourceException extends ResourceException {
     ...
     *            the detail message
     */
    public DataStorageResourceException(String message) {
        super(message);
    }
     ...
     *            the cause
     */
    public DataStorageResourceException(Throwable cause) {
        super(cause);
    }
     ...
     *            the cause
     */
    public DataStorageResourceException(String message, Throwable cause) {
        super(message, cause);
    }
}
