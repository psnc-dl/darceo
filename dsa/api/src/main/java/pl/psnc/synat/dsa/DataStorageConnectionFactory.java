...
/**
 * Common interface of connections' factories to data storages.
 * 
 */
public interface DataStorageConnectionFactory extends Serializable, Referenceable {

    /**
     * Gets a connection to a data storage instance.
     * 
     * @param spec
     *            specific parameters of connection
     * @return connection to data storage
     * @throws DataStorageResourceException
     *             if getting a connection fails
     */
    DataStorageConnection getConnection(DataStorageConnectionSpec spec)
            throws DataStorageResourceException;
